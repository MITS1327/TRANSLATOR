...
import { KeyMessagingController, KeyPrivateHttpController, KeyProtectedHttpController } from './controllers';

@Module({
  imports: [CoreModule, InMemoryStorageModule],
  providers: [CacheKeyService],
  controllers: [KeyPrivateHttpController, KeyProtectedHttpController, KeyMessagingController],
})
